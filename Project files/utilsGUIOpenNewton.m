function utilsGUIOpenNewton(busdata,linedata,basemva,var)
clc;
...
[G,B] = mathCalculateMatrixGandB(linedata,NB);
...
[busdata,int] = mathNewtonRaphsonMethod(busdata,linedata,basemva,erro,maskDP,maskDQ,NB,G,B);
